...
public class InventoryController {
 ...
 @PostMapping("/adjustments") public InventoryTransaction adjust(@Valid @RequestBody Adjustment d){return service.adjustStock(d);}
 @PostMapping("/transfers") @ResponseStatus(HttpStatus.NO_CONTENT) public void transfer(@Valid @RequestBody Transfer d){service.transferStock(d);}
