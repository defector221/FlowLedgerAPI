...
public class TransportDriverController {
    ...
    public TransportDriverController(TransportDriverService service) {
    ...
    public DriverResponse create(@Valid @RequestBody DriverRequest r) {
        return service.create(r);
    }

    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('TRANSPORT_EDIT')")
    public DriverResponse update(@PathVariable UUID id, @Valid @RequestBody DriverRequest r) {
