...
public class TransportVehicleController {
    ...
    public TransportVehicleController(TransportVehicleService service) {
    ...
    public VehicleResponse create(@Valid @RequestBody VehicleRequest r) {
        return service.create(r);
    }

    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('TRANSPORT_EDIT')")
    public VehicleResponse update(@PathVariable UUID id, @Valid @RequestBody VehicleRequest r) {
